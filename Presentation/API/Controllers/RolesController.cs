...
using Application.Features.Commands.Role.Create;
using Application.Features.Commands.Role.Delete;
using Application.Features.Commands.Role.Update;
...
public class RolesController : Controller
{
    ...
    {
        //page veya size a -1 geldiginde direkt olarak rolleri donecek sekilde duzenlenmistir.
